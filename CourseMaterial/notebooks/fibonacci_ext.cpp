...
static PyObject* fib(PyObject*self, PyObject* args, PyObject* kywds)
{
    py::object return_val;
    int exception_occurred = 0;
    PyObject *py_local_dict = NULL;
    static const char *kwlist[] = {"a","local_dict", NULL};
    PyObject *py_a;
    int a_used;
    py_a = NULL;
    a_used = 0;
    
    if(!PyArg_ParseTupleAndKeywords(args,kywds,"O|O:fib",const_cast<char**>(kwlist),&py_a, &py_local_dict))
       return NULL;
    try                              
    {                                
        py_a = py_a;
...
{
    {"fib",(PyCFunction)fib , METH_VARARGS|METH_KEYWORDS},
    {NULL,      NULL}        /* Sentinel */
};
